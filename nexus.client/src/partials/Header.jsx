      ...
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex">
            {/* Hamburger button */}
            <button
              className="pr-64 text-gray-500 hover:text-gray-600 dark:hover:text-gray-400 lg:hidden"
            ...
            <form className="max-w-md mx-auto">
              ...
              <div className="relative w-96">
                <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                  <svg
                    className="w-4 h-4 fill-current text-gray-500/80 dark:text-gray-400/80"
                    width={16}
                    height={16}
                    viewBox="0 0 16 16"
                    xmlns="http://www.w3.org/2000/svg"
